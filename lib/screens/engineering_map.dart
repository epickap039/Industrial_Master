...
class _EngineeringMapScreenState extends State<EngineeringMapScreen> {
  ...
  Widget _buildRevisionRow(
    ...
    return _buildCardNode(
      ...
      cardColor: cardColor,
      borderColor: dividerColor.withValues(alpha: 0.2),
      child: Row(
        ...
        .map<Widget>((tracto) {
          ...
          final tipos =
              (tracto['tipos'] as List).where((tp) {
                ...
                if ((tp['nombre'] as String).toLowerCase().contains(filterLow)) {
                  return true;
                }
          ...
          if (filterLow.isNotEmpty &&
              tipos.isEmpty &&
              !tractoNombre.toLowerCase().contains(filterLow)) {
          ...
          return _buildCardNode(
            initiallyExpanded: false,
            cardColor: cardColor,
            borderColor: dividerColor.withValues(alpha: 0.5),
            child: Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                Container(
            ...
            children:
                tipos.map<Widget>((tipo) {
                  return _buildCardNode(
                    initiallyExpanded: false,
                    cardColor: cardColor,
                    borderColor: dividerColor.withValues(alpha: 0.4),
                    child: Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        Icon(
                        ...
                        (tipo['versiones'] as List).map<Widget>((ver) {
                          ...
                          if (revisiones.isEmpty) {
                            return _buildCardNode(
                              initiallyExpanded: false,
                              cardColor: cardColor,
                              borderColor: dividerColor.withValues(alpha: 0.3),
                              child: Row(
                                mainAxisSize: MainAxisSize.min,
                                children: [
                                  Icon(
                          ...
                          return _buildCardNode(
                            ...
                            children:
                                byCliente.entries.map<Widget>((entry) {
                                  String clname = entry.key;
                                  List<dynamic> revs = entry.value;
                                  return _buildCardNode(
                                    initiallyExpanded: false,
                                    cardColor: cardColor,
                                    borderColor: dividerColor.withValues(alpha: 0.25),
                                    child: Row(
                                      mainAxisSize: MainAxisSize.min,
                                      children: [
                                        Icon(
                                    ...
                                    children:
                                        revs.map<Widget>((item) {
                                          return _buildRevisionRow(
                                            item,
                                            cardColor,
                                            dividerColor,
                                            bodyColor,
  ...
  List<Widget> _buildByClient(
      ...
      for (var tipo in tracto['tipos']) {
        ...
        for (var ver in tipo['versiones']) {
          for (var rev in ver['revisiones']) {
            ...
            hierarchy[clName]![trName]![tpName]!.putIfAbsent(
              ver['nombre'],
              () => [],
            );
    ...
    return hierarchy.entries.map<Widget>((clEntry) {
      return _buildCardNode(
        ...
        children:
            clEntry.value.entries.map<Widget>((trEntry) {
              return _buildCardNode(
                initiallyExpanded: false,
                cardColor: cardColor,
                borderColor: dividerColor.withValues(alpha: 0.4),
                ...
                children:
                    trEntry.value.entries.map<Widget>((tpEntry) {
                      return _buildCardNode(
                        initiallyExpanded: false,
                        cardColor: cardColor,
                        borderColor: dividerColor.withValues(alpha: 0.3),
                        ...
                        children:
                            tpEntry.value.entries.map<Widget>((vEntry) {
                              return _buildCardNode(
                                initiallyExpanded: false,
                                cardColor: cardColor,
                                borderColor: dividerColor.withValues(alpha: 0.2),
